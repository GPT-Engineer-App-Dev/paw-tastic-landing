...
**Project**: paw-tastic-landing 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: a dog landing page with paw icon. 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/paw-tastic-landing.git
cd paw-tastic-landing
npm i
